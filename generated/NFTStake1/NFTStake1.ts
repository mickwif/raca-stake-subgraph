...
export class NFTStake1__getUserStakeHisResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class NFTStake1__poolResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
...
export class NFTStake1 extends ethereum.SmartContract {
  static bind(address: Address): NFTStake1 {
    return new NFTStake1("NFTStake1", address);
  }
  ...
  getUserStakeHis(
    ...
    _index: BigInt,
    _time: BigInt
  ): NFTStake1__getUserStakeHisResult {
    ...
    return new NFTStake1__getUserStakeHisResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_getUserStakeHis(
    ...
    _index: BigInt,
    _time: BigInt
  ): ethereum.CallResult<NFTStake1__getUserStakeHisResult> {
    let result = super.tryCall(
      "getUserStakeHis",
      "getUserStakeHis(uint256,address,uint256,uint256):(uint256,uint256,uint256,bool)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new NFTStake1__getUserStakeHisResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  pool(param0: BigInt): NFTStake1__poolResult {
    let result = super.call(
      "pool",
    ...
    return new NFTStake1__poolResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_pool(param0: BigInt): ethereum.CallResult<NFTStake1__poolResult> {
    let result = super.tryCall(
      "pool",
      "pool(uint256):(address,uint256,uint256,uint8,address,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
