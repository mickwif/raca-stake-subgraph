...
export class RACAstake3__getUserStakeHisResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class RACAstake3__poolResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class RACAstake3 extends ethereum.SmartContract {
  static bind(address: Address): RACAstake3 {
    return new RACAstake3("RACAstake3", address);
  }
  ...
  getUserStakeHis(
    ...
    _index: BigInt,
    _time: BigInt
  ): RACAstake3__getUserStakeHisResult {
    let result = super.call(
      "getUserStakeHis",
    ...
    return new RACAstake3__getUserStakeHisResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_getUserStakeHis(
    ...
    _index: BigInt,
    _time: BigInt
  ): ethereum.CallResult<RACAstake3__getUserStakeHisResult> {
    let result = super.tryCall(
      "getUserStakeHis",
      "getUserStakeHis(uint256,address,uint256,uint256):(uint256,uint256,uint256,bool)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new RACAstake3__getUserStakeHisResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  pool(param0: BigInt): RACAstake3__poolResult {
    let result = super.call(
      "pool",
    ...
    return new RACAstake3__poolResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_pool(param0: BigInt): ethereum.CallResult<RACAstake3__poolResult> {
    let result = super.tryCall(
      "pool",
      "pool(uint256):(address,uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
